...
namespace BeachCallouts
{
    ...
    [CalloutProperties("Southern Command Individuals using Fireworks", "Valandria", "0.0.2")]
    public class SC_Fireworks : Callout
    {
        ...
        public SC_Fireworks()
        {
            ...
            ShortName = "SC - Individuals with Fireworks";
