...
[CalloutProperties("Local Med Vehicle Collision (2 Deaths)", "Valandria", "0.1.0")]
public class CarCrash2Fatal : FivePD.API.Callout
{
    ...
    public CarCrash2Fatal()
    {
        ...
        ShortName = "L Med - Vehicle Collision";
        CalloutDescription = "A vehicle collision has occured with unknown injuries. Get the location and assess. Respond Code 3.";
        ResponseCode = 3;
        StartDistance = 150f;
    }
